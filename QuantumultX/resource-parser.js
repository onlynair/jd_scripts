...
function get_emoji(emojip, sname) {
   var Lmoji = { 
    ...
    "🇸🇬": ["SG", "Singapore","SINGAPORE", "新加坡", "狮城", "沪新", "海新", "京新", "泉新", "穗新", "深新", "杭新", "广新","廣新","滬新"],
    ...
    "🇧🇷": ["BR", "Brazil", "巴西", "圣保罗"],
    "🇯🇵": ["JP", "Japan","JAPAN", "日本", "东京", "大阪", "埼玉", "京日", "苏日", "沪日", "海日", "上日", "穗日", "川日", "中日", "泉日", "杭日", "深日", "辽日", "广日", "Tokyo"],
    "🇦🇷": ["AR", "Argentina", "阿根廷"],
    "🇳🇴": ["Norway", "挪威", "NO"],
    "🇵🇱": [" PL", "POL", "波兰","波蘭", "Poland"],
    "🇨🇱": ["智利","Chile","CHILE"],
    ...
    "🇨🇳": ["CN", "China", "国内", "回国", "中国","中國", "江苏", "北京", "天津", "上海", "广州", "深圳", "杭州", "徐州", "青岛", "宁波", "镇江", "江西", "广西", "沈阳", "苏州", "海南", "陕西", "四川", "辽宁", "大连", "盘锦", "黑龙江", "back"],
    "🇬🇺": [" 关岛"],
    "🇱🇧": ["黎巴嫩","LB", "Lebanon"],
...
function YAMLFix(cnt){
  ...
  cnt = cnt.replace(/\n\s*\-\s*\n.*name/g,"\n  - name").replace(/\$|\`/g,"").split("proxy-providers:")[0].split("proxy-groups:")[0].replace(/\"(name|type|server|port|cipher|password|uuid|obfs-uri|alterId|udp)(\"*)/g,"$1")
    if(Pdbg == 1) {
